...
export const WhatsAppButton: React.FC = () => {
  ...
  return (
    <a
      ...
      className="fixed bottom-6 right-6 bg-green-500 text-white p-4 rounded-full flex items-center justify-center shadow-lg transition-transform transform hover:scale-110"
